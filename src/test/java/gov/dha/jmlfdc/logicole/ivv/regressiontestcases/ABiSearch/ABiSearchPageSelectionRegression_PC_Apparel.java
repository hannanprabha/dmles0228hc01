...
public class ABiSearchPageSelectionRegression_PC_Apparel extends ScriptBase{ 
	...
	public void testChromeSelenium() throws InterruptedException {
		...
		abisearchpage.selectProductType("Apparel and Luggage and Personal Care Products");
